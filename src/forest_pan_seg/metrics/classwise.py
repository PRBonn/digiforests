# This has been modified to allow usage with MultilassJaccardIndex and the like
# also to use with our custom PanopticQuality metrics.
#
...
class ClasswiseWrapper(WrapperMetric):
    ...
    def __getattr__(self, name: str) -> Union[Tensor, "Module"]:
        ...
        if name == "metric" or (
            name in self.__dict__ and name not in self.metric.__dict__
        ):
